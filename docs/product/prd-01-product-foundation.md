...
15. Reading canvas is a freeform workspace with stable world coordinates; pan/zoom remain local view state and layout assistance can expand later without changing persisted reading semantics.
